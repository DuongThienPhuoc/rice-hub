                ...
                <div style={{ flex: '7' }} className='my-10 overflow-x-auto'>
                    <div className='flex flex-col lg:flex-row justify-end items-center lg:items-middle mb-10'>
                        <div className='flex flex-col lg:flex-row items-center mt-4 lg:mt-0'>
                            {!navbarVisible && (
                                <h1 className='font-bold text-[20px] pb-5 px-5'><strong>Danh sách phiếu chi</strong></h1>
                            )}
                            <SearchBar
                    ...
                    <div className='overflow-hidden lg:ml-7'>
                        <ExpenditureList name="Phiếu chi" editUrl="/expenditures/updateExpenditure" titles={titles} columns={columns} data={employees} tableName="expenditures" />
                    </div>
                    {totalPages > 1 && (
                        <Paging
