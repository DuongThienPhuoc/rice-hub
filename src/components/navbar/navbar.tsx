                ...
                {role === 'ROLE_ADMIN' && (
                    <ul className='flex items-center gap-x-10'>
                        ...
                        <div ref={navbarRef} className='relative' onClick={() => handleDropdown4()}>
                            ...
                            <div className={dropdown4 ? 'absolute w-32 z-50 bg-[#FFFFFF] shadow-lg top-12 left-0' : 'hidden'}>
                                <ul className='flex flex-col'>
                                    <li className='hover:bg-gray-200 p-2' onClick={() => router.push('/import')}>Nhập hàng</li>
                                    <li className='hover:bg-gray-200 p-2' onClick={() => router.push('/export')}>Xuất hàng</li>
                                    <li className='hover:bg-gray-200 p-2' onClick={() => router.push('/inventory')}>Kiểm hàng</li>
                                </ul>
                            </div>
                        </div>
                    </ul>
